...
export default function NavItem({ item, level, matchDownLg, navigate, location, matchPath }) {
  ...
  const itemHandler = () => {
    ...
    if (matchDownLg) {/* close drawer if needed */ }
  };
  ...
  return (
    ...
    >
      <ListItemIcon sx={{ color: isSelected ? iconSelectedColor : textColor, minWidth: 28 }}>
        {itemIcon}
      </ListItemIcon>
      <ListItemText
        primary={
